...
<body>
    <header class="header" id="header">
        <section
            style="position: relative; height: 595px; overflow: hidden;">
            <img src="image/<?php echo $destination['category']; ?>/<?php echo $destination['picture']; ?>"
                alt="Destination Image" class="card-img-top"
                style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); min-width: 100%; min-height: 100%; width: auto; height: auto; z-index: -1;">
            <nav>
                <div>
                    <ul class="nav justify-content-center navbar"
                        style="padding-top: 20px; font-family: 'Montserrat', sans-serif; padding-right: 60px; padding-left: 60px;">
                        <a class="navbar-brand me-auto"
                            style="font-weight:600; color: #ffffff; font-size:30px;">Boole</a>
                        <li class="nav-item">
                        ...
                        <button class="navbar-toggler ms-auto" type="button" data-bs-toggle="offcanvas"
                            ...
                            <span>
                                <iconify-icon icon="iconamoon:profile-circle-fill" style="color: white;" width="40"
                ...
                <div class="row g-0">
                    <div class="col-6 col-md-8" style="padding-left: 50px; padding-top: 25px">
                        <div class="container mt-0"
                            style="backdrop-filter: blur(3px); color: wheat; background-color: white; 
                    ...
                    color: black; background: rgb(189, 189, 0); background: rgba(189, 189, 189, 0.5); padding: 10px 20px; border: 1px solid; border-radius: 20px;">
                            ...
                            <a href="<?php echo $destination['link_maps']; ?>" style="margin-top: 10px; margin-bottom: 10px;"class="btn btn-primary"
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"
        integrity="sha384-eUqfzAlFQr1u1KZZ2fKWEeDjR5Fa1l9ajRvABoIXiSAB7DQp6OAp3bI5pG5KkrD"
