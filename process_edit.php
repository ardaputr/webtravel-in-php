        ...
        <h1 style="padding: 20px;">Update Menu</h1>
            <div class="container">
                <div class="row">
                    <div class="col-4"></div>
                    <div class="col-4">
                        <input class="form-control border-dark" type="text" value="<?= $row['place']?>" placeholder="Place Name"
                            aria-label="default input example" name="place"><br>
                        ...
                        <textarea class="form-control border-dark"  rows="3" value="<?= $row['description']?>" placeholder="Description"
                            aria-label="default input example" name="description"></textarea><br>
                        <input class="form-control border-dark" type="text" value="<?= $row['address']?>" placeholder="Address"
                            aria-label="default input example" name="address"><br>
